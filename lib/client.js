...
`;
							...
							children: [
								...
								preview?.status === "ready" && messages.length > 0 && (0, jsx.jsxs)("div", { className: "dac-preview-layout", children: [
									(0, jsx.jsx)("nav", { className: "dac-preview-rail", "aria-label": t("preview.timeline"), children: messages.map((message, index) => (0, jsx.jsx)("button", {
										...
										onClick: () => {
											try { document.getElementById(`dac-preview-node-${String(message.seq)}`)?.scrollIntoView?.({ block: "start", behavior: "smooth" }); } catch { /* host DOM changed */ }
										},
										children: `#${index + 1}`
									}, `${message.seq}-${index}`)) }),
									(0, jsx.jsxs)("div", { className: "dac-preview-feed", children: [
										(0, jsx.jsxs)("div", { className: "dac-preview-column", children: [
											...messages.map((message, index) => (0, jsx.jsx)(PreviewMessage, { node: { ...message, key: String(message.seq) }, t }, `${message.seq}-${index}`)),
		...
		exports.SETTINGS_NS = SETTINGS_NS;
			exports.__test = { formatBytes, matchesArchivedSession, filterByTag, sortArchivedSessions, setVisibleSelection, reconcileSelection, markArchiveDialog, submitExport, submitImportFile, fetchArchivePreview, fetchArchiveSearch, resolvePreviewPrimitives, PreviewMarkdown, PreviewReasoning, editIconSpec: EDIT_ICON_SPEC };
		exports.apply = apply;
