...
`;
		...
		function MetadataDialog({ session, t, busy, returnFocus, fallbackFocusRef, onSave, onCancel }) {
			...
			function importWarningText(t, warning) {
				...
				function TrashGroupSection({ group, t, selected, busy, mutationsAvailable, onToggleSelected, onRestore, onPurge, onPreview }) {
			...
			return (0, jsx.jsxs)("section", { className: "dac-group dac-trash-group", children: [
				(0, jsx.jsxs)("div", { className: "dac-group-head", children: [
					(0, jsx.jsxs)("div", { className: "dac-group-left", children: [
						...
						(0, jsx.jsxs)("span", { className: "dac-group-name", children: [(0, jsx.jsx)(IconFolder, {}), group.title ?? t("group.noProject")] }),
					] }),
					(0, jsx.jsx)("span", { className: "dac-count", children: chatsCount(t, group.items.length) }),
				] }),
				(0, jsx.jsx)("div", { className: "dac-list", children: group.items.map((row) => {
					...
					return (0, jsx.jsxs)("article", { className: `dac-row dac-trash-row${selected.has(row.sessionId) ? " dac-selected" : ""}`, children: [
		...
		function ArchivedChatsSection({ t, refreshSidebar }) {
			...
			const purgeFromTrash = async (ids) => {
				...
				try {
					...
					if (purged.length > 0) setNotice({ kind: "ok", text: t("trash.purged") });
					if ((result?.failed ?? []).length > 0) setNotice({ kind: "error", text: failureText(t, result.failed) });
					await loadTrash();
				} catch (error) {
					setNotice({ kind: "error", text: String(error.message ?? error) });
					...
					pageMode === "trash" && (0, jsx.jsxs)("div", { className: "dac-mode-panel", children: [
						...
						trash.status === "ready" && (0, jsx.jsxs)("div", { className: "dac-trash-toolbar", children: [
							...
							(0, jsx.jsxs)("div", { className: "dac-trash-toolbar-actions", children: [
								selectableTrashIds.length > 0 && (0, jsx.jsx)(SelectionCheckbox, {
								...
								(0, jsx.jsx)("button", { type: "button", className: "dac-bulk-btn", disabled: selectedTrashIds.length === 0 || selectedTrashBusy || !trashMutationsAvailable, onClick: () => restoreFromTrash(selectedTrashIds), children: t("trash.restoreSelected") }),
								(0, jsx.jsx)("button", { type: "button", className: "dac-bulk-btn dac-danger", disabled: selectedTrashIds.length === 0 || selectedTrashBusy || !trashMutationsAvailable, onClick: () => askTrashPurge(selectedTrashIds), children: t("trash.purgeSelected") }),
						...
						...trashGroups.map((group) => (0, jsx.jsx)(TrashGroupSection, {
							group, t, selected: trashSelected, busy: trashBusy, mutationsAvailable: trashMutationsAvailable,
		...
		exports.SETTINGS_NS = SETTINGS_NS;
			exports.__test = { formatBytes, matchesArchivedSession, filterByTag, sortArchivedSessions, setVisibleSelection, reconcileSelection, uniqueSessionIds, groupTrashSessions, trashStatusLabel, markArchiveDialog, submitExport, submitImportFile, fetchTrash, restoreTrash, purgeTrash, emptyTrash, fetchArchivePreview, fetchArchiveImage, fetchArchiveSearch, buildPreviewNodes, previewCopyText, groupPreviewSegments, resolvePreviewPrimitives, PreviewMarkdown, PreviewReasoning, PreviewImage, editIconSpec: EDIT_ICON_SPEC };
		exports.apply = apply;
