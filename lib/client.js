				...
				children: (0, jsx.jsxs)("div", {
					...
					children: [
						...
						(0, jsx.jsxs)("div", { className: "dac-tag-editor", children: [
							...tags.map((tag) => (0, jsx.jsx)("button", { type: "button", className: "dac-chip", "aria-label": `Remove ${tag}`, onClick: () => setTags((current) => current.filter((value) => value !== tag)), children: tag }, tag)),
							(0, jsx.jsx)("input", {
								id: "dac-meta-tags",
							ref: tagInputRef,
							type: "text",
