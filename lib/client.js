...
.dac-lineage-scopebar{border:1px solid var(--dsw-alias-border-l2);border-radius:9px;background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary);font-size:11px;line-height:17px;padding:9px 11px}
...
`;
		...
		function validAbout(value) {
			...
			function ArchiveTabs({ pageMode, onChange, t }) {
			...
			_react.useEffect(() => {
				if (notice?.kind !== "ok" || notice.action === "view-archived") return undefined;
			...
			return (0, jsx.jsxs)("div", {
				...
				children: [
					...
					(0, jsx.jsx)(ArchiveTabs, { pageMode, onChange: setPageMode, t }),
