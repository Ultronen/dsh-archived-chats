...
`;
		...
		function HistoryPanel({ active, t, onPreview, onRestored, fallbackFocusRef }) {
			...
			const confirmDelete = async () => {
				...
				setDeleteBusy(true);
				try {
					const result = current.kind === "one"
						? await deleteHistoryVersion(current.version.snapshotId)
			...
			const deleteBody = deleteDialog === null ? "" : deleteDialog.kind === "one"
				? (() => {
			...
			return (0, jsx.jsxs)("div", { className: "dac-mode-panel dac-history-panel", children: [
				...
				deleteDialog !== null && (0, jsx.jsx)(ConfirmDialog, {
					...
					body: deleteBody,
					confirmLabel: t(deleteDialog.kind === "one" ? "history.deleteConfirm" : "history.clear"),
					cancelLabel: t("confirm.cancel"),
					busy: deleteBusy,
		...
		function ArchivedChatsSection({ t, refreshSidebar }) {
			...
			return (0, jsx.jsxs)("div", {
				...
				(0, jsx.jsxs)("div", {
					...
					pageMode === "history" && (0, jsx.jsx)(HistoryPanel, { active: true, t, onPreview: openHistoryPreview, onRestored: historyRestored, fallbackFocusRef: pageHeadingRef }),
