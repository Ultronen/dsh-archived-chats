...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"workspaceArchive.action": "按项目批量归档",
			"workspaceArchive.title": "按项目批量归档",
			"workspaceArchive.close": "关闭批量归档",
			"workspaceArchive.loading": "正在加载项目…",
			"workspaceArchive.choose": "选择项目",
			"workspaceArchive.choosePlaceholder": "选择一个项目",
			"workspaceArchive.preview": "查看归档预览",
			"workspaceArchive.previewTitle": "归档预览",
			"workspaceArchive.candidates": "将归档的聊天",
			"workspaceArchive.skipped": "跳过的聊天",
			"workspaceArchive.sessionLive": "正在使用中，已跳过",
			"workspaceArchive.confirm": "继续确认",
			"workspaceArchive.confirmTitle": "确认批量归档？",
			"workspaceArchive.confirmBody": "将只归档上方预览中的聊天；项目本身不会改变。",
			"workspaceArchive.apply": "确认归档",
			"workspaceArchive.applying": "正在归档…",
			"workspaceArchive.result": "批量归档结果",
			"workspaceArchive.archived": "已归档",
			"workspaceArchive.failed": "失败",
			"workspaceArchive.snapshotFailed": "历史快照未保存",
			"workspaceArchive.done": "完成",
			"workspaceArchive.unsupported": "当前 DSH 版本不支持按项目批量归档。",
			"workspaceArchive.error": "无法完成按项目批量归档，请重试。",
			"workspaceArchive.reason.session-live": "正在使用中，已跳过",
			...
			"workspaceArchive.status.captured": "历史快照已保存",
			"workspaceArchive.status.snapshot-failed": "历史快照未保存",
			"workspaceArchive.reason.unknown": "未完成",
			"workspaceArchive.eligibleCount": "可归档 {count}",
			"workspaceArchive.liveCount": "活跃 {count}"
		};
		const en = {
			"locale.intl": "en-US",
			"nav": "Session Archive",
			...
			"workspaceArchive.action": "Archive workspace chats",
			"workspaceArchive.title": "Archive workspace chats",
			"workspaceArchive.close": "Close workspace archive",
			"workspaceArchive.loading": "Loading workspaces…",
			"workspaceArchive.choose": "Choose a workspace",
			"workspaceArchive.choosePlaceholder": "Choose a workspace",
			"workspaceArchive.preview": "Review archive preview",
			"workspaceArchive.previewTitle": "Archive preview",
			"workspaceArchive.candidates": "Chats to archive",
			"workspaceArchive.skipped": "Skipped chats",
			"workspaceArchive.sessionLive": "Currently active; skipped",
			"workspaceArchive.confirm": "Continue to confirmation",
			"workspaceArchive.confirmTitle": "Confirm workspace archive?",
			"workspaceArchive.confirmBody": "Only the chats in this preview will be archived. The workspace itself will not change.",
			"workspaceArchive.apply": "Confirm archive",
			...
			"workspaceArchive.snapshotFailed": "History snapshot was not saved",
			...
			"workspaceArchive.reason.session-live": "Currently active; skipped",
			...
			"workspaceArchive.status.captured": "History snapshot saved",
			"workspaceArchive.status.snapshot-failed": "History snapshot was not saved",
			"workspaceArchive.reason.unknown": "Not completed",
			"workspaceArchive.eligibleCount": "Eligible {count}",
			"workspaceArchive.liveCount": "Active {count}"
		};
		//#endregion
...
.dac-history-panel{display:flex;flex-direction:column;gap:12px}
.dac-history-toolbar{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap}
.dac-history-note{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:19px}
.dac-history-clear{flex:none}
.dac-history-groups{display:flex;flex-direction:column;border-top:1px solid var(--dsw-alias-border-l2)}
.dac-history-group{border-bottom:1px solid var(--dsw-alias-border-l2)}
.dac-history-group-toggle{width:100%;display:flex;align-items:center;justify-content:space-between;gap:12px;border:0;background:transparent;color:var(--dsw-alias-label-primary);font:inherit;text-align:left;padding:12px 2px;cursor:pointer}
.dac-history-group-main{min-width:0;display:flex;align-items:center;gap:8px}
.dac-history-group-copy{min-width:0;display:flex;flex-direction:column;gap:2px}
.dac-history-group-title{overflow-wrap:anywhere;font-size:14px;font-weight:600;line-height:20px}
.dac-history-group-meta{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}
.dac-history-timeline{display:flex;flex-direction:column;margin:0 0 12px 10px;border-left:1px solid var(--dsw-alias-border-l2);padding-left:14px}
.dac-history-version{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 2px}
.dac-history-version+.dac-history-version{border-top:1px solid var(--dsw-alias-border-l2)}
.dac-history-version-main{min-width:0;display:flex;flex-direction:column;gap:4px}
.dac-history-version-meta{display:flex;align-items:center;gap:7px;flex-wrap:wrap;color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}
.dac-history-actions{display:flex;align-items:center;gap:6px;flex-wrap:wrap;justify-content:flex-end}
.dac-history-delete{color:var(--dsw-alias-state-error-primary)}
.dac-history-delete:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}
.dac-history-status{display:inline-flex;border-radius:6px;background:var(--dsw-alias-interactive-bg-hover,rgba(127,127,127,.12));color:var(--dsw-alias-label-secondary);padding:1px 6px}
.dac-history-degraded{display:flex;flex-direction:column;gap:6px;border-top:1px solid var(--dsw-alias-border-l2);padding-top:12px}
.dac-history-degraded-row{display:flex;justify-content:space-between;gap:12px;color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px;overflow-wrap:anywhere}
...
.dac-workspace-dialog{box-sizing:border-box;width:min(560px,calc(100vw - 32px));max-height:calc(100vh - 32px);overflow:auto}
.dac-workspace-body{display:flex;flex-direction:column;gap:12px;padding-top:14px;color:var(--dsw-alias-label-primary)}
...
`;
		...
		async function fetchHistoryPreview(snapshotId, offset = 0, limit = 50, signal) {
			return post("/history/preview", { snapshotId, offset, limit }, signal);
		}

		async function fetchHistoryImage(snapshotId, attachment, signal) {
			const res = await fetch(`${API_BASE}/history/preview/image`, {
				method: "POST",
				headers: { "content-type": "application/json", [GUARD_HEADER]: "1" },
				body: JSON.stringify({ snapshotId, attachment }),
				signal,
			});
			if (!res.ok) {
		...
		async function prepareHistoryRestore(snapshotId) {
			return post("/history/restore/preview", { snapshotId });
		}

		async function confirmHistoryRestore(token, nonce) {
			return post("/history/restore", { token, nonce });
		}

		async function deleteHistoryVersion(snapshotId) {
			return post("/history/delete", { snapshotId });
		}

		async function clearHistoryVersions() {
			return post("/history/delete-all", {});
		}
		...
		function WorkspaceArchiveDialog({ t, returnFocus, fallbackFocusRef, onClose, onApplied }) {
			const [workspaces, setWorkspaces] = _react.useState([]);
			const [workspaceId, setWorkspaceId] = _react.useState("");
			const [preview, setPreview] = _react.useState(null);
			const [result, setResult] = _react.useState(null);
			const [stage, setStage] = _react.useState("loading");
			...
			const mountedRef = _react.useRef(true);
			const loadRequestRef = _react.useRef(0);
			const previewRequestRef = _react.useRef({ sequence: 0, workspaceId: "" });
			...
			const countLabel = (key, count) => t(key).replace("{count}", String(Number.isFinite(count) ? count : 0));
			...
			_react.useEffect(() => {
				...
				return () => {
					...
					const usable = previous !== null && previous !== document.body && typeof previous?.focus === "function"
						&& (typeof document.contains !== "function" || document.contains(previous));
					(usable ? previous : fallbackFocusRef?.current)?.focus?.();
				};
			}, [returnFocus, fallbackFocusRef]);
			const loadWorkspaces = _react.useCallback(async () => {
				const request = ++loadRequestRef.current;
				setBusy(true); setError(null); setStage("loading");
				try {
					const body = await fetchWorkspaceArchiveWorkspaces();
					if (!mountedRef.current || loadRequestRef.current !== request) return;
					setWorkspaces(Array.isArray(body?.workspaces) ? body.workspaces : []); setStage("select");
				} catch (reason) {
					if (mountedRef.current && loadRequestRef.current === request) { setError(reason); setStage("error"); }
				} finally { if (mountedRef.current && loadRequestRef.current === request) setBusy(false); }
			}, []);
			_react.useEffect(() => { mountedRef.current = true; void loadWorkspaces(); return () => { mountedRef.current = false; loadRequestRef.current += 1; previewRequestRef.current = { sequence: previewRequestRef.current.sequence + 1, workspaceId: "" }; }; }, [loadWorkspaces]);
			const requestPreview = async () => {
				if (workspaceId === "" || busy) return;
				const request = { sequence: previewRequestRef.current.sequence + 1, workspaceId };
				previewRequestRef.current = request;
				setBusy(true); setError(null);
				try {
					const next = await previewWorkspaceArchive(workspaceId);
					if (mountedRef.current && previewRequestRef.current === request && workspaceId === request.workspaceId) { setPreview(next); setStage("preview"); }
				} catch (reason) { if (mountedRef.current && previewRequestRef.current === request) { setError(reason); setStage("error"); } }
				finally { if (mountedRef.current && previewRequestRef.current === request) setBusy(false); }
			};
			const apply = async () => {
				if (preview === null || busy || stage !== "confirm") return;
				setBusy(true); setError(null);
				try {
					const applied = await applyWorkspaceArchive(preview.token, preview.nonce);
					setResult(applied); setStage("result");
					if (Array.isArray(applied.archived) && applied.archived.length > 0) try { await onApplied?.(applied); } catch { /* the completed result remains readable */ }
				} catch (reason) { setError(reason); setStage("error"); }
				finally { setBusy(false); }
			};
			const previewSessions = Array.isArray(preview?.sessions) ? preview.sessions : [];
			const previewSkipped = Array.isArray(preview?.skipped) ? preview.skipped : [];
			const resultRows = (label, rows) => (0, jsx.jsxs)("section", { className: "dac-workspace-result-group", children: [
				(0, jsx.jsx)("strong", { children: label }),
				(0, jsx.jsx)("ul", { children: (Array.isArray(rows) ? rows : []).map((item) => (0, jsx.jsx)("li", { children: typeof item === "string" ? item : `${safeLabel(item)} · ${safeReason(item?.reason, item?.status)}` }, typeof item === "string" ? item : `${item?.id}:${item?.reason ?? item?.status ?? ""}`)) })
			] });
			return (0, jsx.jsx)("div", { className: "dac-confirm-overlay", onClick: close, children: (0, jsx.jsxs)("div", {
				...
				children: [
					(0, jsx.jsxs)("div", { className: "dac-preview-head", children: [
						(0, jsx.jsx)("strong", { id: "dac-workspace-archive-title", children: t("workspaceArchive.title") }),
						(0, jsx.jsx)("button", { ref: closeRef, type: "button", className: "dac-iconbtn", disabled: busy, "aria-label": t("workspaceArchive.close"), onClick: close, children: (0, jsx.jsx)(IconClose, { size: 16 }) })
					] }),
					stage === "loading" && (0, jsx.jsx)("div", { className: "dac-center", children: t("workspaceArchive.loading") }),
					stage === "select" && (0, jsx.jsxs)("div", { className: "dac-workspace-body", children: [
						(0, jsx.jsx)("label", { htmlFor: "dac-workspace-archive-select", children: t("workspaceArchive.choose") }),
						(0, jsx.jsxs)("select", { id: "dac-workspace-archive-select", disabled: busy, "data-workspace-archive-select": "1", className: "dac-select dac-select-fill", value: workspaceId, onChange: (event) => { previewRequestRef.current = { sequence: previewRequestRef.current.sequence + 1, workspaceId: event.target.value }; setPreview(null); setBusy(false); setWorkspaceId(event.target.value); }, children: [
							(0, jsx.jsx)("option", { value: "", children: t("workspaceArchive.choosePlaceholder") }),
							...workspaces.map((workspace) => (0, jsx.jsx)("option", { value: workspace.id, children: `${safeLabel(workspace)} · ${countLabel("workspaceArchive.eligibleCount", workspace.eligibleCount)} · ${countLabel("workspaceArchive.liveCount", workspace.liveCount)}` }, workspace.id))
						] }),
						(0, jsx.jsx)("button", { type: "button", className: "dac-btn-primary", disabled: workspaceId === "" || busy, "data-workspace-archive-preview": "1", onClick: requestPreview, children: t("workspaceArchive.preview") })
					] }),
					stage === "preview" && (0, jsx.jsxs)("div", { className: "dac-workspace-body", children: [
						(0, jsx.jsx)("strong", { children: t("workspaceArchive.previewTitle") }),
						(0, jsx.jsx)("span", { className: "dac-workspace-target", children: safeLabel(preview?.workspace) }),
						(0, jsx.jsx)("span", { children: t("workspaceArchive.candidates") }),
						(0, jsx.jsx)("ul", { children: previewSessions.map((item) => (0, jsx.jsx)("li", { children: safeLabel(item) }, item.id)) }),
						previewSkipped.length > 0 && (0, jsx.jsxs)("div", { children: [(0, jsx.jsx)("span", { children: t("workspaceArchive.skipped") }), (0, jsx.jsx)("ul", { children: previewSkipped.map((item) => (0, jsx.jsx)("li", { children: `${safeLabel(item)} · ${safeReason(item.reason)}` }, item.id)) })] }),
						(0, jsx.jsx)("button", { type: "button", className: "dac-btn-primary", "data-workspace-archive-confirm": "1", onClick: () => setStage("confirm"), children: t("workspaceArchive.confirm") })
					] }),
					stage === "confirm" && (0, jsx.jsxs)("div", { className: "dac-workspace-body", children: [
						(0, jsx.jsx)("strong", { children: t("workspaceArchive.confirmTitle") }),
						(0, jsx.jsx)("p", { children: t("workspaceArchive.confirmBody") }),
						(0, jsx.jsx)("button", { type: "button", className: "dac-btn-danger", disabled: busy, "data-workspace-archive-apply": "1", onClick: apply, children: busy ? t("workspaceArchive.applying") : t("workspaceArchive.apply") })
					] }),
					stage === "result" && (0, jsx.jsxs)("div", { className: "dac-workspace-body", "data-workspace-archive-result": "1", children: [
						(0, jsx.jsx)("strong", { children: t("workspaceArchive.result") }),
					...
					stage === "error" && (0, jsx.jsxs)("div", { className: "dac-workspace-body dac-error", role: "status", children: [
						...
						(0, jsx.jsx)("button", { type: "button", className: "dac-btn", disabled: busy, onClick: () => { void loadWorkspaces(); }, children: t("state.retry") })
					] })
				]
			}) });
		}
		...
		function MetadataDialog({ session, t, busy, returnFocus, fallbackFocusRef, onSave, onCancel }) {
			...
			function importWarningText(t, warning) {
				...
				function PreviewImage({ sessionId, attachment, t, scope = "archive" }) {
					...
					_react.useEffect(() => {
						...
						const load = async () => {
							...
							try {
								const blob = scope === "history"
									? await fetchHistoryImage(sessionId, attachment, controller.signal)
									: await fetchArchiveImage(sessionId, attachment.attachmentId, controller.signal, scope);
								if (disposed) return;
				...
				function PreviewDialog({ preview, t, busy, returnFocus, fallbackFocusRef, onLoadMore, onCancel }) {
					...
					const snapshotMs = preview?.scope === "history" && typeof preview?.snapshot?.createdAt === "string"
						? Date.parse(preview.snapshot.createdAt) : NaN;
					const previewSourceId = preview?.scope === "history" ? preview?.snapshot?.snapshotId : preview?.session?.id;
					_react.useEffect(() => {
						const previousFocus = returnFocus ?? document.activeElement;
							...
							children: [
								(0, jsx.jsxs)("div", { className: "dac-preview-head", children: [
									(0, jsx.jsxs)("div", { className: "dac-preview-heading", children: [
										...
										Number.isFinite(snapshotMs) && (0, jsx.jsx)("time", { dateTime: preview.snapshot.createdAt, children: `${t("history.snapshotAt")}: ${formatDate(t, snapshotMs)}` })
									] }),
		...
		function HistoryPanel({ active, t, onPreview, onRestored, fallbackFocusRef }) {
			...
			const [restoreDialog, setRestoreDialog] = _react.useState(null);
			const [restoreBusy, setRestoreBusy] = _react.useState(null);
			const [deleteDialog, setDeleteDialog] = _react.useState(null);
			const [deleteBusy, setDeleteBusy] = _react.useState(false);
			const [message, setMessage] = _react.useState(null);
			const restoreReturnFocusRef = _react.useRef(null);
			...
			_react.useEffect(() => {
				...
				const timer = setTimeout(() => setMessage((current) => current === message ? null : current), 4000);
			...
			const sessions = state.sessions.filter((session) => {
				...
				return [session?.title, session?.workspace?.title].some((value) => typeof value === "string"
			...
			const clearSummary = {
				versionCount: deletable.length,
				sessionCount: new Set(deletable.map((item) => item.session.sessionId)).size,
				bytes: deletable.reduce((sum, item) => sum + (Number.isSafeInteger(item.version.totalBytes) ? item.version.totalBytes : 0), 0),
			};
			const toggle = (sessionId) => setExpanded((current) => {
				const next = new Set(current);
				if (next.has(sessionId)) next.delete(sessionId);
				else next.add(sessionId);
				return next;
			});
			const beginRestore = async (session, version) => {
				if (restoreBusy !== null) return;
				if (restoreDialog === null) restoreReturnFocusRef.current = document.activeElement;
				setRestoreBusy(version.snapshotId);
				setMessage(null);
				try {
					const prepared = await prepareHistoryRestore(version.snapshotId);
					setRestoreDialog({ session, version, prepared, error: null });
				} catch {
					setMessage({ kind: "error", text: t("history.error") });
				} finally {
					setRestoreBusy(null);
				}
			};
			const confirmRestore = async () => {
				if (restoreDialog === null || restoreBusy !== null) return;
				if (restoreDialog.prepared === null) {
					await beginRestore(restoreDialog.session, restoreDialog.version);
					return;
				}
				const current = restoreDialog;
				setRestoreBusy(current.version.snapshotId);
				try {
					const result = await confirmHistoryRestore(current.prepared.token, current.prepared.nonce);
					...
					setRestoreDialog((dialog) => dialog === null ? null : { ...dialog, prepared: null, error: t("history.restoreError") });
				} finally {
					setRestoreBusy(null);
				}
			};
			const restoreBody = restoreDialog === null ? "" : (() => {
				const title = restoreDialog.session.title || t("chat.untitled");
				const createdMs = Date.parse(restoreDialog.version.createdAt);
				const created = Number.isFinite(createdMs) ? formatDate(t, createdMs) : restoreDialog.version.createdAt;
				const destinationId = restoreDialog.prepared?.destination?.sessionId ?? "";
				const warning = (restoreDialog.prepared?.warnings ?? []).length > 0 ? ` ${t("history.restoreWorkspaceWarning")}` : "";
				const base = isZh(t)
					? `“${title}”的 ${created} 版本将创建一个新的已归档副本${destinationId === "" ? "" : ` ${destinationId}`}，不会覆盖原聊天。`
					: `The ${created} version of “${title}” will create a new archived copy${destinationId === "" ? "" : ` ${destinationId}`}. It will not overwrite the original chat.`;
				return `${base}${warning}${restoreDialog.error === null ? "" : ` ${restoreDialog.error}`}`;
			})();
			const askDeleteVersion = (session, version) => {
				if (version.state !== "history" || deleteBusy || restoreDialog !== null) return;
			...
			const askClearHistory = () => {
				...
				deleteReturnFocusRef.current = document.activeElement;
				setDeleteDialog({ kind: "all", summary: clearSummary });
				setMessage(null);
			};
			const confirmDelete = async () => {
				if (deleteDialog === null || deleteBusy) return;
			...
			return (0, jsx.jsxs)("div", { className: "dac-mode-panel dac-history-panel", children: [
				(0, jsx.jsxs)("div", { className: "dac-history-toolbar", children: [
					(0, jsx.jsx)("div", { className: "dac-history-note", role: "note", children: t("history.note") }),
					(0, jsx.jsxs)("button", {
						type: "button",
						className: "dac-btn-danger dac-history-clear",
						disabled: clearSummary.versionCount === 0 || deleteBusy || deleteDialog !== null || restoreDialog !== null,
						onClick: askClearHistory,
						children: [(0, jsx.jsx)(IconTrash, { size: 14 }), (0, jsx.jsx)("span", { children: t("history.clear") })],
					}),
				] }),
				(0, jsx.jsxs)("div", { className: "dac-search", children: [
					(0, jsx.jsx)(IconSearch, {}),
					(0, jsx.jsx)("input", { type: "search", placeholder: t("history.search"), value: query, onChange: (event) => setQuery(event.target.value) }),
				] }),
				message?.kind === "ok" && (0, jsx.jsxs)("div", { className: "dac-toast", role: "status", children: [
					(0, jsx.jsx)(IconCheckCircle, {}),
					(0, jsx.jsx)("span", { children: message.text }),
					(0, jsx.jsx)("button", { type: "button", "aria-label": t("notice.dismiss"), onClick: () => setMessage(null), children: (0, jsx.jsx)(IconClose, {}) }),
				] }),
				message?.kind === "error" && (0, jsx.jsxs)("div", { className: "dac-notice", role: "status", children: [
					(0, jsx.jsx)("span", { children: message.text }),
					(0, jsx.jsx)("button", { type: "button", "aria-label": t("notice.dismiss"), onClick: () => setMessage(null), children: (0, jsx.jsx)(IconClose, {}) }),
				] }),
				state.status === "loading" && (0, jsx.jsxs)("div", { className: "dac-center", children: [(0, jsx.jsx)("span", { className: "dac-spin" }), (0, jsx.jsx)("span", { children: t("history.loading") })] }),
				state.status === "error" && (0, jsx.jsxs)("div", { className: "dac-center", children: [
					(0, jsx.jsx)("span", { children: t("history.error") }),
					(0, jsx.jsx)("button", { type: "button", className: "dac-retry", onClick: load, children: t("state.retry") }),
				] }),
				state.status === "ready" && state.sessions.length === 0 && state.degraded.length === 0 && (0, jsx.jsx)("div", { className: "dac-empty", children: t("history.empty") }),
				state.status === "ready" && state.sessions.length > 0 && sessions.length === 0 && (0, jsx.jsx)("div", { className: "dac-center", children: t("history.emptyFiltered") }),
				state.status === "ready" && sessions.length > 0 && (0, jsx.jsx)("div", { className: "dac-history-groups", children: sessions.map((session) => {
					const open = expanded.has(session.sessionId);
					const title = session.title || t("chat.untitled");
					const versions = Array.isArray(session.versions) ? session.versions : [];
					return (0, jsx.jsxs)("section", { className: "dac-history-group", children: [
						(0, jsx.jsxs)("button", { type: "button", className: "dac-history-group-toggle", "aria-expanded": open, "aria-label": `${open ? t("history.collapse") : t("history.expand")}: ${title}`, onClick: () => toggle(session.sessionId), children: [
							(0, jsx.jsxs)("span", { className: "dac-history-group-main", children: [
								(0, jsx.jsx)("span", { className: open ? "dac-chev open" : "dac-chev", children: (0, jsx.jsx)(IconChevron, {}) }),
								(0, jsx.jsxs)("span", { className: "dac-history-group-copy", children: [
									(0, jsx.jsx)("span", { className: "dac-history-group-title", children: title }),
									(0, jsx.jsx)("span", { className: "dac-history-group-meta", children: [session.workspace?.title, t(`history.scope.${session.scope}`)].filter(Boolean).join(" · ") }),
								] }),
							] }),
							(0, jsx.jsx)("span", { className: "dac-count", children: versionCount(versions.length) }),
						] }),
						open && (0, jsx.jsx)("div", { className: "dac-history-timeline", role: "list", children: versions.map((version) => {
							const createdMs = Date.parse(version.createdAt);
							const attachments = Number.isInteger(version.attachmentCount) ? version.attachmentCount : 0;
							return (0, jsx.jsxs)("article", { className: "dac-history-version", role: "listitem", children: [
								(0, jsx.jsxs)("div", { className: "dac-history-version-main", children: [
									(0, jsx.jsx)("time", { className: "dac-row-date", dateTime: version.createdAt, children: Number.isFinite(createdMs) ? formatDate(t, createdMs) : version.createdAt }),
									(0, jsx.jsxs)("div", { className: "dac-history-version-meta", children: [
										(0, jsx.jsx)("span", { children: formatBytes(version.totalBytes ?? 0) }),
										(0, jsx.jsx)("span", { children: isZh(t) ? `${attachments} ${t("history.attachments")}` : `${attachments} ${t("history.attachments")}` }),
										(0, jsx.jsx)("span", { className: "dac-history-status", children: t(`history.state.${version.state}`) }),
										(0, jsx.jsx)("span", { className: "dac-history-status", children: t("history.health.ready") }),
									] }),
								] }),
								(0, jsx.jsxs)("div", { className: "dac-history-actions", children: [
									(0, jsx.jsx)("button", { type: "button", className: "dac-btn", onClick: () => onPreview?.(session, version), children: t("history.preview") }),
									(0, jsx.jsx)("button", { type: "button", className: "dac-btn", disabled: restoreBusy !== null || restoreDialog !== null || deleteBusy || deleteDialog !== null, onClick: () => { void beginRestore(session, version); }, children: t("history.restore") }),
									(0, jsx.jsx)("button", {
										type: "button",
										className: "dac-btn dac-history-delete",
										"data-snapshot-id": version.snapshotId,
										title: version.state === "recycle-protection" ? t("history.deleteProtected") : void 0,
										disabled: version.state === "recycle-protection" || deleteBusy || deleteDialog !== null || restoreDialog !== null,
										onClick: () => askDeleteVersion(session, version),
				...
				state.status === "ready" && state.degraded.length > 0 && (0, jsx.jsxs)("section", { className: "dac-history-degraded", children: [
					(0, jsx.jsx)("strong", { children: t("history.degraded") }),
				...
				restoreDialog !== null && (0, jsx.jsx)(ConfirmDialog, {
					...
					body: restoreBody,
					confirmLabel: t(restoreDialog.prepared === null ? "history.restoreAgain" : "history.restoreConfirm"),
					cancelLabel: t("confirm.cancel"),
					confirmClassName: "dac-btn-primary",
					busy: restoreBusy !== null,
					returnFocus: restoreReturnFocusRef.current,
					fallbackFocusRef,
		...
		function ArchivedChatsSection({ t, refreshSidebar }) {
			...
			const [workspaceArchiveOpen, setWorkspaceArchiveOpen] = _react.useState(false);
			...
			const historyRestored = _react.useCallback(async () => {
				await refresh();
				refreshSidebar?.();
			}, [refresh, refreshSidebar]);
			const workspaceArchiveApplied = _react.useCallback(async () => {
				await Promise.allSettled([
					refresh(),
					Promise.resolve().then(() => refreshSidebar?.()),
					Promise.resolve().then(() => refreshWorkspaceRegistry()),
				]);
				setWorkspaceArchiveRefresh((current) => current + 1);
			}, [refresh, refreshSidebar]);
			...
			const openHistoryPreview = async (session, version) => {
				const request = beginPreviewRequest();
				const safeSession = { id: session.sessionId, title: session.title, workspace: session.workspace ?? null };
				const snapshot = { snapshotId: version.snapshotId, sessionId: session.sessionId, createdAt: version.createdAt };
				previewReturnFocusRef.current = document.activeElement;
				setPreview({ status: "loading", session: safeSession, snapshot, scope: "history", messages: [], total: 0, nextOffset: null });
				setPreviewBusy(true);
				try {
					const result = await fetchHistoryPreview(version.snapshotId, 0, 50, request.controller.signal);
					if (!ownsPreviewRequest(request)) return;
					setPreview({
						...result,
						status: "ready",
					...
					if (!ownsPreviewRequest(request)) return;
					setPreview({ status: "error", session: safeSession, snapshot, scope: "history", messages: [], total: 0, nextOffset: null, error: String(error.message ?? error) });
				} finally {
					if (ownsPreviewRequest(request)) setPreviewBusy(false);
				}
			};
			...
			const loadMorePreview = async () => {
				if ((!preview?.session?.id && !preview?.snapshot?.snapshotId) || preview.nextOffset === null || previewBusy) return;
				const sessionId = preview.session.id;
				const nextOffset = preview.nextOffset;
				const request = beginPreviewRequest();
				setPreviewBusy(true);
				try {
					const result = preview.scope === "history"
						? await fetchHistoryPreview(preview.snapshot.snapshotId, nextOffset, 50, request.controller.signal)
						: await fetchArchivePreview(sessionId, nextOffset, 50, request.controller.signal, preview.scope ?? "archive");
					if (!ownsPreviewRequest(request)) return;
			...
			return (0, jsx.jsxs)("div", {
								...
								children: [
									...
									(0, jsx.jsx)("div", { className: "dac-action-wrap", children:
										(0, jsx.jsxs)("button", {
											type: "button",
											className: "dac-action-trigger",
											onClick: (event) => { workspaceArchiveReturnFocusRef.current = event.currentTarget; setWorkspaceArchiveOpen(true); },
											children: [(0, jsx.jsx)(IconArchive, { size: 15 }), (0, jsx.jsx)("span", { children: t("workspaceArchive.action") })]
										})
									}),
				...
				(0, jsx.jsxs)("div", {
					...
					workspaceArchiveOpen && (0, jsx.jsx)(WorkspaceArchiveDialog, {
						t,
						returnFocus: workspaceArchiveReturnFocusRef.current,
						fallbackFocusRef: pageHeadingRef,
						onClose: () => setWorkspaceArchiveOpen(false),
		...
		let refreshWorkspaceRegistry = async () => {};
		...
		function apply(ctx) {
			...
			refreshWorkspaceRegistry = async () => { await ctx.get("workspaces")?.refresh?.(); };
