...
`;
		...
		function MetadataDialog({ session, t, busy, returnFocus, fallbackFocusRef, onSave, onCancel }) {
			...
			function importWarningText(t, warning) {
				...
				function PreviewMessage({ node, sessionId, t, bindNode }) {
					...
					const segments = groupPreviewSegments(node?.segments).map((group, index) => group.kind === "images"
						? (0, jsx.jsx)("div", {
							...
							children: group.images.map((segment, imageIndex) => (0, jsx.jsx)(PreviewImage, { sessionId, attachment: segment.attachment, t }, `${node.key}:${index}:${imageIndex}`)),
								...
								preview?.status === "ready" && nodes.length > 0 && (0, jsx.jsxs)("div", { className: "dac-preview-layout", children: [
									...
									(0, jsx.jsxs)("div", { ref: feedRef, className: "dac-preview-feed", children: [
										(0, jsx.jsxs)("div", { className: "dac-preview-column", children: [
											...nodes.map((node) => (0, jsx.jsx)(PreviewMessage, { node, sessionId: preview?.session?.id, t, bindNode: bindNode(node.key) }, node.key)),
		...
		exports.SETTINGS_NS = SETTINGS_NS;
			exports.__test = { formatBytes, matchesArchivedSession, filterByTag, sortArchivedSessions, setVisibleSelection, reconcileSelection, markArchiveDialog, submitExport, submitImportFile, fetchArchivePreview, fetchArchiveImage, fetchArchiveSearch, buildPreviewNodes, previewCopyText, groupPreviewSegments, resolvePreviewPrimitives, PreviewMarkdown, PreviewReasoning, PreviewImage, editIconSpec: EDIT_ICON_SPEC };
		exports.apply = apply;
