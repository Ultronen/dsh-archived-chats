...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"workspaceArchive.skippedLive": "将跳过 {count} 个正在使用的会话。",
		...
		const en = {
			...
			"workspaceArchive.skippedLive": "Skipping {count} chats currently in use.",
...
.dac-workspace-actions .dac-btn,.dac-workspace-actions .dac-btn-danger{min-width:96px;border-radius:12px;font-size:16px;line-height:22px;padding:10px 18px}
...
.dac-workspace-actions .dac-btn:hover:not(:disabled),.dac-workspace-actions .dac-btn-danger:hover:not(:disabled){opacity:.84}
.dac-workspace-actions .dac-btn:focus-visible,.dac-workspace-actions .dac-btn-danger:focus-visible{outline:2px solid var(--dsw-alias-interactive-primary,#6e6ef7);outline-offset:2px}
		...
		function WorkspaceArchiveDialog({ t, workspaceId, workspaceTitle, restoreFocus, onClose, onApplied }) {
			...
			const apply = async () => {
				...
				try {
					...
					if (archived.length > 0) try { await onApplied?.(applied); } catch { /* the completed result remains readable */ }
				} catch (reason) {
			...
			return (0, jsx.jsx)("div", { className: "dac-confirm-overlay", onClick: close, children: (0, jsx.jsxs)("div", {
				...
				children: [
					...
					stage === "empty" && (0, jsx.jsxs)("div", { className: "dac-workspace-body", role: "status", children: [
						(0, jsx.jsx)("p", { className: "dac-workspace-copy", children: t("workspaceArchive.empty") }),
						skippedLiveNotice,
					] }),
