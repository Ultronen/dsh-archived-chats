...
@media (max-width:640px){[role="dialog"][data-dac-section-active="1"]>nav{display:none}[role="dialog"][data-dac-section-active="1"]>nav+div{width:100%;min-width:0}.dac-head{align-items:flex-start}.dac-head-actions{max-width:none}.dac-action-trigger{padding:5px 9px}.dac-selection-controls{width:100%;justify-content:space-between}.dac-bulkbar{align-items:flex-start;flex-direction:column}.dac-bulk-actions{width:100%;flex-wrap:wrap}.dac-row{align-items:flex-start}.dac-row-actions{gap:4px}.dac-unarchive{padding:5px 10px}.dac-summary{gap:6px}.dac-row-meta{gap:4px}}
`;
		...
		function ArchivedChatsSection({ t, refreshSidebar }) {
			...
			_react.useEffect(() => {
				...
				const onKey = (event) => { if (event.key === "Escape") setActionMenu(null); };
				document.addEventListener("mousedown", onDown);
				document.addEventListener("keydown", onKey);
				return () => {
								...
								(0, jsx.jsxs)("div", {
									...
									children: [
										(0, jsx.jsxs)("div", { className: "dac-action-wrap", children: [
											...
											actionMenu === "import" && (0, jsx.jsxs)("div", { className: "dac-action-menu", role: "menu", children: [
												(0, jsx.jsx)("button", { type: "button", role: "menuitem", className: "dac-action-menu-item", disabled: importBusy, onClick: () => { setActionMenu(null); importInputRef.current?.click?.(); }, children: t("import.backup") }),
												(0, jsx.jsx)("button", { type: "button", role: "menuitem", className: "dac-action-menu-item", disabled: interop.busy, onClick: () => chooseInteropImport("codex"), children: t("interop.import.codex") }),
												(0, jsx.jsx)("button", { type: "button", role: "menuitem", className: "dac-action-menu-item", disabled: interop.busy, onClick: () => chooseInteropImport("claude"), children: t("interop.import.claude") })
											] })
										] }),
										(0, jsx.jsxs)("div", { className: "dac-action-wrap", children: [
											(0, jsx.jsxs)("button", {
											...
											actionMenu === "export" && (0, jsx.jsxs)("div", { className: "dac-action-menu", role: "menu", children: [
												(0, jsx.jsx)("button", { type: "button", role: "menuitem", className: "dac-action-menu-item", disabled: allBusy, onClick: () => { const didExport = exportSessions(selectedIds.length > 0 ? selectedIds : allIds); setActionMenu(null); if (didExport && selectedIds.length > 0) finishSelectionMode(); }, children: t("export.backup") }),
												(0, jsx.jsx)("button", { type: "button", role: "menuitem", className: "dac-action-menu-item", disabled: interop.busy, onClick: () => { setActionMenu(null); void loadInteropExportPreview(selectedIds.length > 0 ? selectedIds : allIds, "codex"); }, children: t("interop.export.codex") }),
												(0, jsx.jsx)("button", { type: "button", role: "menuitem", className: "dac-action-menu-item", disabled: interop.busy, onClick: () => { setActionMenu(null); void loadInteropExportPreview(selectedIds.length > 0 ? selectedIds : allIds, "claude"); }, children: t("interop.export.claude") })
											] })
										] }),
										(0, jsx.jsxs)("div", { className: "dac-action-wrap", children: [
											(0, jsx.jsxs)("button", {
											...
											actionMenu === "more" && (0, jsx.jsx)("div", { className: "dac-action-menu", role: "menu", children: (0, jsx.jsx)("button", { type: "button", role: "menuitem", className: "dac-action-menu-item dac-danger", onClick: () => { setActionMenu(null); askDelete(allIds, void 0); }, children: t("delete.all") }) })
										] })
										]
									}),
									(0, jsx.jsx)("input", {
				...
				(0, jsx.jsxs)("div", {
					...
					(0, jsx.jsxs)("div", {
						...
						children: [
							...
							visibleIds.length > 0 && (0, jsx.jsxs)("div", {
								className: "dac-selection-controls",
								children: [
									selectionMode && (0, jsx.jsxs)("label", {
