...
`;
		...
		function MetadataDialog({ session, t, busy, returnFocus, fallbackFocusRef, onSave, onCancel }) {
			...
			function importWarningText(t, warning) {
				...
				function PreviewToolResult({ segment, t }) {
					const [open, setOpen] = _react.useState(false);
					const DisclosureRow = previewPrimitives.DisclosureRow;
					const body = (0, jsx.jsx)("div", { className: `dac-preview-tool-body${segment.isError ? " dac-error" : ""}`, children: (0, jsx.jsx)("pre", { className: "dac-preview-tool-result", children: segment.text || "" }) });
								...
								preview?.status === "ready" && nodes.length > 0 && (0, jsx.jsxs)("div", { className: "dac-preview-layout", children: [
									...
									(0, jsx.jsxs)("div", { ref: feedRef, className: "dac-preview-feed", children: [
										(0, jsx.jsxs)("div", { className: "dac-preview-column", children: [
											...nodes.map((node) => (0, jsx.jsx)(PreviewMessage, { node, t, bindNode: bindNode(node.key) }, node.key)),
		...
		exports.SETTINGS_NS = SETTINGS_NS;
			exports.__test = { formatBytes, matchesArchivedSession, filterByTag, sortArchivedSessions, setVisibleSelection, reconcileSelection, markArchiveDialog, submitExport, submitImportFile, fetchArchivePreview, fetchArchiveSearch, buildPreviewNodes, previewCopyText, resolvePreviewPrimitives, PreviewMarkdown, PreviewReasoning, editIconSpec: EDIT_ICON_SPEC };
		exports.apply = apply;
