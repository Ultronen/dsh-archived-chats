 ...
 */
async function sweepPendingDeletions(ctx, registry, persistence, statsService, metadataStore, pendingStore) {
    let pending;
    try {
    ...
    for (const id of [...pending]) {
        try {
            ...
            const outcome = await deleteSession(ctx, registry, persistence, id, undefined, statsService, metadataStore, pendingStore);
...
//#region routes
function registerRoutes(ctx, webServer, registry, persistence, titleCache, metadataStore, statsService, pendingStore) {
...
export function apply(ctx) {
    ...
    const registerWebSurface = () => {
        ...
        registerRoutes(ctx, webServer, registry, persistence, titleCache, metadataStore, statsService, pendingStore);
        ...
        void sweepPendingDeletions(ctx, registry, persistence, statsService, metadataStore, pendingStore)
