...
//#region routes
function registerRoutes(ctx, webServer, registry, persistence, titleCache, metadataStore) {
...
export function apply(ctx) {
    ...
    const registerWebSurface = () => {
        ...
        registered = true;
        registerRoutes(ctx, webServer, registry, persistence, titleCache, metadataStore);
